...
<script>
	function loadState() {
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) {
				...
				for (i = 0; i < jsonObj.length; i++) {
					...
					document.registeredUserForm.stateDrop.options
							.add(createOption);
		...
		xmlhttp
				.open(
						"get",
						"${pageContext.request.contextPath}/RegisteredUserController?flag=loadState&countryId="
	...
	/* function removeAllState() {
		var removeState = document.registeredUserForm.stateDrop.options.length;
		for (i = removeState; i > 0; i--) {
			document.registeredUserForm.stateDrop.remove(i);
		} */
	}
	loadState("load");
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Registered User
								Registration </header>
								...
								<div class=" form">
									...
									<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
											...
											<form class="cmxform form-horizontal tasi-form"
												id="registeredUserForm" name="registeredUserForm"
												method="post"
												action="${pageContext.request.contextPath}/RegisterUserController">

									<c:forEach items="${sessionScope.RegisteredUserNameList}"
										var="l">
										<c:forEach items="${sessionScope.RegisteredUserProfileList}"
											var="i">
												<input type="hidden" value="updateRegisteredUser"
													name="flag"> <input type="hidden"
													name="registeredUserId" value="${i.registeredUserId}">
												...
												<div class="form-group ">
													...
													<div class="col-lg-10">
														<input class=" form-control" id="cname"
															value="${i.firstName}" name="cname" minlength="2"
															type="text" required />
													</div>
												</div>
												<div class="form-group ">
													<label for="cname1" class="control-label col-lg-2">Last
														Name</label>
													<div class="col-lg-10">
														<input class=" form-control" id="cname1"
															value="${i.lastName}" name="cname1" minlength="2"
															type="text" required />
													</div>
												</div>
												<div class="form-group ">
													<label for="cname2" class="control-label col-lg-2">User
														Name</label>
													<div class="col-lg-10">
														<input class=" form-control" id="cname2"
															value="${l.userName}" name="cname2" minlength="2"
															type="text" required />
													</div>
												</div>
												<div class="form-group ">
													...
													<div class="col-lg-10">
														<input class=" form-control" id="cname3"
															value="${l.password}" name="cname3" minlength="2"
											...
											<label for="cname4" class="control-label col-lg-2">Confirm
												Password</label>
											<div class="col-lg-10">
												<input class=" form-control" id="cname4" value="${i.confirmPassword}" name="cname4"
													minlength="2" type="password" required />
											</div>
										</div>  --%>
												<div class="form-group ">
													<label for="cname5" class="control-label col-lg-2">D.O.B
													</label>
													<div class="col-lg-10">
														<input type="date" class=" form-control" id="cname5"
															value="${i.dateOfBirth}" name="cname5" minlength="2"
															type="text" required />
													</div>
												</div>
												<div class="form-group ">
													...
													<div class="col-lg-10">
														<input class="form-control " id="cemail"
															value="${l.email}" type="email" name="cemail" required />
													</div>
												</div>
												<div class="form-group ">
													<label for="cname6" class="control-label col-lg-2">Phone-no
													</label>
													<div class="col-lg-10">
														<input class=" form-control" id="cname6"
															value="${i.phoneNumber}" name="cname6" minlength="2"
															type="text" required />
													</div>
												</div>
												<div class="form-group ">
													<label for="cname7" class="control-label col-lg-2">Address
													</label>
													<div class="col-lg-10">
														<input class=" form-control" id="cname7"
															value="${i.address}" name="cname7" minlength="2"
															type="text" required />
													</div>
												</div>
