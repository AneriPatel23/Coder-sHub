...
{
	var user1=document.getElementById("cname").value;
//	alert("hi"+user1);
	var xmlhttp;
		...
		xmlhttp.open("get", "${pageContext.request.contextPath}/DeveloperController?flag=createWorkspace&cname="+user1, true);
		xmlhttp.send();
							...
							<div class="panel-body">
								<div class=" form">
									<form class="cmxform form-horizontal tasi-form"
										...
										<input type="hidden" name="flag" value="insertDeveloper">
										...
										<div class="form-group ">
											...
											<div class="col-lg-10">
												<input type="date" class=" form-control" id="cname2"  name="cname2" 
													minlength="2" type="text" required />
											</div>
										</div>
										<div class="form-group ">
										...
										<div class="form-group ">
											...
											<div class="col-lg-10">
												<input class=" form-control" id="cname5" name="cname5"
													minlength="2" type="text" required />
											</div>
										</div>
