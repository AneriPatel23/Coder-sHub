		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Module Details </header>
							<div class="panel-body">
								...
								<c:forEach items="${sessionScope.pqr}" var="row">
									...
									<form class="cmxform form-horizontal tasi-form"
										id="commentForm" method="post" action="${pageContext.request.contextPath}/ModuleController">
										<input type="hidden" name="flag" value="update">
										<input type="hidden" name="moduleId" value="${row.moduleId}" >
										
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">Project
												Name</label>
											<div class="col-lg-10">
												<select class="form-control m-bot15" name="projectDrop">
										...
										<div class="form-group ">
											<label for="cname1" class="control-label col-lg-2">Module
												Name</label>
											<div class="col-lg-10">
												<input class=" form-control" id="cname1" value="${i.moduleName}" name="cname1"
