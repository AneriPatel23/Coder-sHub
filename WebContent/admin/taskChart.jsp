...
<body>
	<%
		Integer regesteredUserCount = (Integer) session
				.getAttribute("registeredUserCountList");
		Integer developerCount = (Integer) session
				.getAttribute("developerList");
		Integer companyCount = (Integer) session
			.getAttribute("companyList");
		Integer userCount = (Integer) session
		...
		obj[0] = "Regestered User";
		obj[1] = regesteredUserCount;
		ls.add(obj);
		obj = new Object[2];
		obj[0] = "Developer";
		obj[1] = developerCount;
		ls.add(obj);
		obj = new Object[2];
		obj[0] = "Company User";
		obj[1] = companyCount;
