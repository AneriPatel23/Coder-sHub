		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> State Details </header>
							<div class="panel-body">
								<div class=" form">
							 <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
							 	<c:forEach items="${sessionScope.lsStateedit }" var="row">
							 
									<form class="cmxform form-horizontal tasi-form"
										id="commentForm" method="post" action="${pageContext.request.contextPath}/StateController">
										<input type="hidden" name="flag" value="updateState" >
										<input type="hidden" name="stateId" value="${row.stateId}" >
										
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">Country
												Name</label>
											<div class="col-lg-10">
											...
											<c:forEach items="${sessionScope.countryList}" var="j">
												<c:if test="${j.countryId eq row.cv.countryId}">
													<option value="${j.countryId}" selected="selected">${j.countryName}</option>
												</c:if>
												<c:if test="${j.countryId ne row.cv.countryId}">
								 ...
								 <%-- <c:forEach items="${sessionScope.lsStatesearch}" var="i"> --%>
										
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">State
												Name</label>
											<div class="col-lg-10">
												<input class=" form-control" id="cname" value="${row.stateName}" name="cname"
													minlength="2" type="text" required />
											</div>
										</div>
										<div class="form-group ">
											<label for="cname1" class="control-label col-lg-2">Description</label>
											<div class="col-lg-10">
												<textarea class="form-control " id="cname1" name="cname1"
