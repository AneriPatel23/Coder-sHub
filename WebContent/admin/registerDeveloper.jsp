...
<base href="${pageContext.request.contextPath}/admin/">
  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <form class="form-signin" action="${pageContext.request.contextPath}/RegisterDeveloperController" method="post" name="registerDeveloperForm">
        ...
        <div class="login-wrap">
          <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
           <select class="form-control" name="companyDrop" id="companyDrop" autofocus name="cname8">
             
													<option>Select Company</option>
													<c:forEach items="${sessionScope.lsCompany}" var="i">
    	  ...
    	  <input type="text" class="form-control" placeholder="Phone no." autofocus name="cname6">
            ...
            <!-- <div class="login-social-link">
                ...
                <a href="registerUser.jsp" class="facebook">
                    User
                </a>
            </div> -->
