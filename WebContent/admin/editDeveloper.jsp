						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class=" form">
								 ...
								 <c:forEach items="${sessionScope.lsDeveloperedit}" var="i">
								
									<form class="cmxform form-horizontal tasi-form"
										id="commentForm" method="post" action="${pageContext.request.contextPath}/DeveloperController">
										...
										<div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cemail" type="email" value="${i.email}" name="cemail" required />
                                          </div>
                                      </div>
