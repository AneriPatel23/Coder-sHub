								...
								<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
								 ...
								 <c:forEach items="${sessionScope.pqr}" var="i">
									...
									<form class="cmxform form-horizontal tasi-form"
										id="commentForm" method="post" action="${pageContext.request.contextPath}/ComplainController">
										...
										<div class="form-group ">
											...
											<div class="col-lg-10">
												<input class=" form-control" id="cname" value="${i.subject}" name="cname"
										...
										<div class="form-group ">
                                          	...
                                          	<div class="col-lg-10">
                                              	<textarea class="form-control " id="cname1" value="${i.description}" name="cname1" required></textarea>
                                          	</div>
                                      	</div>
                                      	<div class="form-group ">
                                          	<label for="cname2" class="control-label col-lg-2">Other</label>
                                          	<div class="col-lg-10">
                                              	<input class=" form-control" id="cname2" value=${i.other} name="cname2" minlength="2" type="text" required />
                                          	</div>
                                      	</div>								
										<div class="form-group">
