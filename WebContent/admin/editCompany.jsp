					...
					<div class="col-lg-12">
						<section class="panel">
							...
							<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
								<c:forEach items="${sessionScope.lsCompanyedit}" var="i">
								
									<form class="cmxform form-horizontal tasi-form" name="companyForm"
										id="companyForm" method="post" action="${pageContext.request.contextPath}/CompanyController" >
										...
										<div class="form-group ">
											<label for="cname2" class="control-label col-lg-2">User
												Name</label>
											<div class="col-lg-10">
												<input class=" form-control" id="cname2" value="${i.userName}" name="cname2"
													minlength="2" type="text" required />
											</div>
										</div>
										<div class="form-group ">
											...
											<div class="col-lg-10">
												<input class=" form-control" id="cname3" value="${i.password}" name="cname3"
