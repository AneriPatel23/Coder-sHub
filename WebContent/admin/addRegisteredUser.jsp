...
<!--[if lt IE 9]>
 ...
 <script>
  /* function loadState()
	...
	{
	//alert("hi");	
	var user=document.getElementById("cname2").value;
	//alert("hi"+user);
	File dir = new File("C:\\apache-tomcat-7.0.52\\webapps\\"+user);	   
	dir.mkdir();
	} */
    ...
    <script>
     function createWorkspace()
     {
    	 var user1=document.getElementById("cname2").value;
//    		alert("hi"+user1);
    		var xmlhttp;
    			...
    			xmlhttp.open("get", "${pageContext.request.contextPath}/RegisteredUserController?flag=createWorkspace&cname="+user1, true);
    			xmlhttp.send();
     }
    </script>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Registered User Registration </header>
							<div class="panel-body">
								<div class=" form">
								<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
									<form class="cmxform form-horizontal tasi-form"
										id="commentForm" name="registeredUserForm" method="post" action="${pageContext.request.contextPath}/RegisteredUserController">
										...
										<div class="form-group ">
											...
											<div class="col-lg-10">
												<input type="date" class=" form-control" id="cname5" name="cname5"
													minlength="2" type="text" required />
											</div>
										</div>
										<div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cemail" type="email" name="cemail" required />
                                          </div>
                                      </div>
										<div class="form-group ">
											...
											<div class="col-lg-10">
												<input class=" form-control" id="cname6" name="cname6"
													minlength="2" type="text" required />
											</div>
										</div>
										<div class="form-group ">
											...
											<div class="col-lg-10">
												<input class=" form-control" id="cname7" name="cname7"
													minlength="2" type="text" required />
											</div>
										</div>
										<div class="form-group ">
											<label for="cname8" class="control-label col-lg-2">Country
												Name</label>
											<div class="col-lg-10">
												<select class="form-control m-bot15" name="countryDrop" id="countryDrop"  required="" onchange="loadState()">
										...
										<div class="form-group ">
											<label for="cname9" class="control-label col-lg-2">State
												Name</label>
											<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-offset-2 col-lg-10">
												<button class="btn btn-danger" type="submit" onclick="createWorkspace()">Submit</button>
