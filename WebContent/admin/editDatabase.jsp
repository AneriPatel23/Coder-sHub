								...
								<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
								 ...
								 <c:forEach items="${sessionScope.pqr}" var="i">
									...
									<form class="cmxform form-horizontal tasi-form"
										id="commentForm" method="post" action="${pageContext.request.contextPath}/DatabaseController">
										<input type="hidden" name="flag" value="updateDatabase">
										<input type="hidden" name="databaseId" value="${i.databaseId}">
										<div class="form-group ">
											<label for="cname1" class="control-label col-lg-2">Database
												Name</label>
											<div class="col-lg-10">
												<input class=" form-control" id="cname1" value="${i.databaseName}" name="cname1"
