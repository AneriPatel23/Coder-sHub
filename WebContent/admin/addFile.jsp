								...
								<div class=" form">
								 <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
									<form class="cmxform form-horizontal tasi-form"
										id="commentForm" name="fileForm" method="post" action="${pageContext.request.contextPath}/FileController">
										...
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">Project
												Name</label>
											<div class="col-lg-10">
												<select class="form-control m-bot15" name="projectDrop" id="projectDrop" onchange="loadModule()" required="">
										...
										<div class="form-group ">
											<label for="cname1" class="control-label col-lg-2">Module
												Name</label>
											<div class="col-lg-10">
												<select class="form-control m-bot15"  name="moduleDrop" id="moduleDrop" required="">
													<option>select</option>
													<c:forEach items="${sessionScope.abc1}" var="j">
													<option value="${j.moduleId}">${j.moduleName}</option>
													</c:forEach>
												</select>
											</div>
										</div>
