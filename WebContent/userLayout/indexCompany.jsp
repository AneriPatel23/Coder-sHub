...
function loadDeveloper()
{
	...
	xmlhttp.onreadystatechange = function() {
		...
		if (xmlhttp.readyState == 4) 
		{
			...
			for(i=0 ; i<jsonObj.length ; i++)
			{
				...
				p.innerHTML=jsonObj[i].developerName;
				...
				a.setAttribute("href","${pageContext.request.contextPath}/RegisterCompanyController?flag=searchDeveloperFromCompany");
	...
	xmlhttp.open("get", "${pageContext.request.contextPath}/RegisterCompanyController?flag=searchDeveloperFromCompany", true);
	xmlhttp.send();
          ...
          <section class="wrapper">
              ...
              <div class="row state-overview">
                <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
                  <form  method="get" id="form11" class="raw">
                   <!-- Create Project : <input type="text" name="cname" id="ProjectName"> -->
                 <!--   <input type="hidden" name="flag" value="searchDeveloperFromCompany">
                   <input type="submit" name="Create">
                   <br> -->
                   <div class="raw">
                   <c:forEach items="${sessionScope.lsLoadDeveloper}" var="i">
                 

							<div class="col-lg-3 col-sm-6"
								style="height: 50px; background-color: white; font-size: 20px; margin: 10px; border-radius: 10px">
								<a
									href="/codersHubFinl/ProjectController?flag=insideDeveloper&amp;developerName=${i.developerId}">
									<section class="panel" style="TEXT-ALIGN: -webkit-center;">
