...
function loadState(flag)
{
	...
	xmlhttp.open("get", "${pageContext.request.contextPath}/RegisteredUserController?flag=loadState&countryId="+countryId.value, true);
	xmlhttp.send();
									...
									<form class="cmxform form-horizontal tasi-form"
										...
										<c:forEach items="${sessionScope.RegisteredUserProfileList}"
												...
												<input type="hidden" value="updateRegisteredUser"
													name="flag">
												<input type="hidden" name="registeredUserId"
													value="${i.registeredUserId}">
												...
												<div class="form-group ">
													...
													<div class="col-lg-10">
														<input class=" form-control" id="cname2"
															value="${i.loginVO.userName}" name="cname2" minlength="2"
															type="text" required />
													</div>
												</div>
												<div class="form-group ">
													...
													<div class="col-lg-10">
														<input class=" form-control" id="cname3"
															value="${i.loginVO.password}" name="cname3" minlength="2"
												...
												<div class="form-group ">
													...
													<div class="col-lg-10">
														<input class="form-control " id="cemail"
															value="${i.loginVO.email}" type="email" name="cemail" required />
													</div>
												</div>
												<div class="form-group ">
