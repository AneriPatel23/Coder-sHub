	...
	xmlhttp.onreadystatechange = function() {
		...
		if (xmlhttp.readyState == 4) 
		{
			...
			for(i=0 ; i<jsonObj.length ; i++)
			{
				...
				createListItem.setAttribute("style","background-image: url('userLayout/icons/closed.gif')");
    ...
    $(function() {
        $.contextMenu({
            ...
            items: {
                ...
                "new": {name: "New",
                	"items": {"asdasd" : {"name":"asdadsas"},	 "asdasd21" : {"name":"asdadsa12s"}, "asdasd2111" : {"name":"asdadsa12s111"},
